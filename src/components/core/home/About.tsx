...
export function About() {
    return <section className={styles.About}>
        <div>
            <h5>ABOUT YASASHVI ECOGREEN</h5>
            <h2>Enabling Sustainable Global Trade</h2>
            <p>Yasashvi Ecogreen L.L.C operates as a reliable trading and supply coordination partner, connecting producers and buyers through transparent, compliant, and customer-centric trade execution.
