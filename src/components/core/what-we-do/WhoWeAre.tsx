            ...
            <div className={styles.grid}>
                ...
                <div className={styles.left}>
                    ...
                    <p className={styles.description}>
                        We manage international trade of recycled and processed metallurgical
                        materials, ensuring compliance, documentation accuracy, and efficient
                ...
                <div className={styles.bottomRight}>
                    ...
                    <p className={styles.text}>
                        This reduces supply chain complexity while supporting closed-loop  material cycles.
                    </p>
